...
import '../../../platforms/meta/models/stop_loss_threshold.dart' as _i2;

abstract class ThresholdTrailingStopLoss implements _i1.SerializableModel {
...
class _ThresholdTrailingStopLossImpl extends ThresholdTrailingStopLoss {
  ...
  ThresholdTrailingStopLoss copyWith({
    ...
    return ThresholdTrailingStopLoss(
      thresholds:
          thresholds ?? this.thresholds.map((e0) => e0.copyWith()).toList(),
