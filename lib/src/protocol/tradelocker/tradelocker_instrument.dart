...
abstract class TradelockerInstrument implements _i1.SerializableModel {
...
class _TradelockerInstrumentImpl extends TradelockerInstrument {
  ...
  TradelockerInstrument copyWith({
    ...
    return TradelockerInstrument(
      ...
      tickCost: tickCost ?? this.tickCost.map((e0) => e0.copyWith()).toList(),
      tickSize: tickSize ?? this.tickSize.map((e0) => e0.copyWith()).toList(),
      tradeSessionId:
